	...
	return (
		<div className="header">
			<div className="logo-container">
				<img className="logoImage" src ={"https://www.logodesign.net/logo/smoking-burger-with-lettuce-3624ld.png?nwm=1&nws=1&industry=fast-food&sf=&txt_keyword=All"}></img>
			</div>
...
const RestaurantCard = (props) => {
	...
	return (
		<div className="res-card" style={{ backgroundColor: "#f0f0f0" }}>
			<img alt="res-logo" className="resImage" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_300,h_300,c_fit/" + cloudinaryImageId}></img>
			<h3>{name}</h3>
			<h4>{cuisines.join(", ")}</h4>
			<h4>⭐️{avgRating}</h4>
